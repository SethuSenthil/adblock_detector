    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              'Press the button below to check for Adblock',
            ),
          ],
        ),
      ),
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          ...
          // * Check Docs for more supported ad networks, custom Ad Networks also supported
          // ! if internet is unavailable it will default to false (no adblock detected)

          print('adblock test complete with value: $isAdblocking');

          if (isAdblocking) {
            //show alert that ad blocking is detected
            showDialog<void>(
              context: context,
                  ...
                  content: const SingleChildScrollView(
                    child: ListBody(
                      children: <Widget>[
                        ...
                        Text(
                            'Would you like check if user is connected to AdGuard DNS?'),
                      ],
                    ),
                  ),
                  actions: <Widget>[
                    TextButton(
                      ...
                      onPressed: () async {
                        bool isAdGuardDns =
                            await adBlockDetector.isAdguardDNS();
                        ...
                        showDialog<void>(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text(
                                  'AdGuard DNS ${isAdGuardDns ? 'Detected' : 'Not Detected'}'),
                              actions: <Widget>[
                                TextButton(
            ...
            //show alert that adblocking is NOT detected
